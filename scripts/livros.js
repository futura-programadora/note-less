...
document.querySelector('#bem-vindo').textContent = `Bem-vindo aos seus livros ${usuario.nomeUsuario} `;
...
async function listarProjetos() {
  ...
  try {
    ...
    const projetos = todosProjetos.filter(p => p.tipo.toLowerCase() === 'livro');
